...
public final class SensorInfoResponse {
    ...
    @QueryProjection
    public SensorInfoResponse(long gatewayId, String sensorId, String sensorLocation, String sensorSpot) {
    ...
    public static SensorInfoResponse of(long gatewayId, String sensorId, String sensorLocation, String sensorSpot) {
